...
new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
  ...
  watch: {
    ...
    'product.id': function productId() {
      // cek jika nilai dari product > id ada
      if (this.product.id) {
        // maka menjalankan methods getProduct
        this.getProduct();
      }
    },
  ...
  // menggunakan libarary select2 ketika file ini diload
  // mounted sama hal nya seperti document ready pada ajax atau event
  mounted: function mounted() {
    var _this = this;
    ...
    // memanggil methode getCart() untuk load cookie cart
    this.getCart();
  },
  ...
  methods: {
    ...
    getCart: function getCart() {
      ...
      __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('/api/cart').then(function (response) {
        // data yang di terima disimpan ke dalam var shopping cart
    ...
    sendOrder: function sendOrder() {
      ...
      // jika var customer email dan data lain tidak kosong
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_sweetalert2_dist_sweetalert2_min_js__ = __webpack_require__(167);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_sweetalert2_dist_sweetalert2_min_css__ = __webpack_require__(168);
